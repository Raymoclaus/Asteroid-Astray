...
{
	[CustomPropertyDrawer(typeof(FloatComponent), true)]
	public class FloatComponentCustomisedEditor : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			FloatComponent comp = (FloatComponent) fieldInfo.GetValue(target);
