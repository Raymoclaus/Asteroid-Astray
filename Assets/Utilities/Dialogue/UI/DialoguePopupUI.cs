...
using UnityEngine;
using TextMeshProUtilities;

namespace DialogueSystem.UI
{
	public class DialoguePopupUI : PopupUI
	{
		private static DialogueController currentDialogue;
		private static event Action OnShowDialogue;
		...
		public static void ShowDialogue(DialogueController dialogueController)
		{
			currentDialogue = dialogueController;
		...
		protected virtual void GeneratePopup(string name, string line,
