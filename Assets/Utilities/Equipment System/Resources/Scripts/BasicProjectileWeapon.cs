...
{
	public class BasicProjectileWeapon : BasicEquipment, IProjectileEquipment
	{
		[SerializeField] private Transform holderDirectionPivot;
		...
		protected Vector3 HolderDirection => holderDirectionPivot.up;
		...
		public override AttackManager Attack(float damageMultiplier, List<IAttacker> owners)
		{
			...
			ammo.SetInitialWeaponDirection(HolderDirection);
			ammo.SetIntialVelocity(FireVelocity);
			ammo.SetInitialWeaponPivot(WeaponPosition);
